# Односвязный список, хранящий строки длиной менее 100 символов
...
#### Требования:
Используйте для синхронизации доступа к элементам списка _спинлоки_, _мутексы_ и
_блокировки чтения-записи_. Понаблюдайте как изменяются (и изменяются ли) значения
